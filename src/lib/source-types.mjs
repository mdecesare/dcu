// The six DCU source types. Letters, names and legend wording live here only,
// so the coloured markers read the same on every page.
// Legend wording is taken from the Methodology page definitions.
// Colours are set in src/styles/global.css (--src-r, --src-p, --src-v, --src-g, --src-o, --src-u).
...
export const SOURCE_TYPES = {
  ...
  U: { name: 'Utility', legend: 'electric and gas utilities describing their own service processes and timelines' },
};
